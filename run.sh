...
#LOG4J=${LOG4J:=}
DEFAULT_JAVA_OPTS="--SERVER_PORT=7050 -Dspring.profiles.active=prod --PSQL_HOST=postgresql.ch8wfucynpvq.us-east-1.rds.amazonaws.com --PSQL_PORT=5431 --PSQL_DB=procurement --PSQL_USER=postgres --PSQL_PSWD=P0$tGr3$&s3qua1$n3t!k5 -Djdk.tls.acknowledgeCloseNotify=true -Xms1g -Xmx1g -XX:NewRatio=1 -XX:+ResizeTLAB -XX:+UseConcMarkSweepGC -XX:+CMSConcurrentMTEnabled -XX:+CMSClassUnloadingEnabled -XX:-OmitStackTraceInFastThrow"
